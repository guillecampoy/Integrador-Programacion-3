...
public class DatosSemillaFactory {
  ...
  private static Set<Pedido> crearPedidos(UsuariosSemilla usuarios, ProductosSemilla productos) {
    ...
    Pedido pedido1 =
        crearPedido(
            LocalDate.of(2026, 5, 10), Estado.CONFIRMADO, FormaPago.TARJETA, usuarios.ana());
    ...
    Pedido pedido2 =
        crearPedido(
            LocalDate.of(2026, 5, 12), Estado.PENDIENTE, FormaPago.EFECTIVO, usuarios.ana());
    ...
    Pedido pedido3 =
        crearPedido(
            LocalDate.of(2026, 5, 13), Estado.TERMINADO, FormaPago.TRANSFERENCIA, usuarios.bruno());
  ...
  private record CategoriasSemilla(
      Set<Categoria> todas, Categoria almacen, Categoria bebidas, Categoria limpieza) {}
