...
public class EntradaValidada {
  ...
  public String leerOpcion(String prompt, Set<String> opcionesValidas) {
    return leerTextoValidado(
        prompt, entrada -> opcionesValidas.contains(entrada), "Opcion invalida.");
  }

  public String leerTextoNoVacio(String prompt) {
    return leerTextoValidado(prompt, entrada -> !entrada.isBlank(), "Ingrese un texto no vacio.");
  }

  public String leerTexto(String prompt, Predicate<String> validador, String mensajeError) {
  ...
  private String leerTextoValidado(
      String prompt, Predicate<String> validador, String mensajeError) {
    while (true) {
      String entrada = leerLinea(prompt);
